...
# Dataset Path
data_phase = 2
train_dataset_path = f"data/{dataset_name}/phase{data_phase}_train.jsonl"
val_rate = 0.05
...
instructions = { # for problem info, which includes 'question' and 'answer'.
    "step-by-step": "Solve step-by-step for given 'question': {} (answer: {})",
...
def set_trainer(train_dataset, val_dataset):#, test_dataset):
    ...
    generation_arguments = GenerationConfig(
        #do_sample=True, # Llama3 set defaults
        #top_k=50,
        #num_beams=2
    )
    ...
    training_arguments = TrainingArguments(
        ...
        #generation_config=generation_arguments
    )
